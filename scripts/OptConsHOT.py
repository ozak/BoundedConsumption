...
# Output directory
dir=os.getenv("HOME")+'/Dropbox/LatexMe/Consumption/data/T/HOAC/'
...
if os.path.exists(dir)==False:
    os.mkdir(dir)
if constant==0:
    dir=os.getenv("HOME")+'/Dropbox/LatexMe/Consumption/data/T/HOAC/constant/'
    if os.path.exists(dir)==False:
        os.mkdir(dir)
file=dir+'optconsT'
...
yt=np.array(y1[[sample(p) for i in range(1000)]])
