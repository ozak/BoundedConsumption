...
dir=os.getenv("HOME")+'/Dropbox/LatexMe/Consumption/data/HOAC/'+alg+'/'+str(HO)+'/'
...
#agrid=np.arange(0.01,2,0.01)       # Intercept
agrid=np.arange(0.01,y1.max(),0.01)  #y1.max(),0.01)       # Intercept 
